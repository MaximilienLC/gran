# From https://github.com/eloialonso/iris/blob/main/src/models/actor_critic.py
...
from envs.space_model_env import SpaceModelEnv
...
class ActorCritic(nn.Module):
    ...
    def compute_loss(
        ...
        **kwargs: Any
        ...
        outputs = self.imagine(batch, tokenizer, space_model, horizon=imagine_horizon)
    ...
    def imagine(
        ...
        wm_env = SpaceModelSpace(tokenizer, space_model, device)
