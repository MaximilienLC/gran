...
class MDNRNN(BaseModel):
    def __init__(self) -> None:
        ...
        self.num_features = cfg.predictor.num_features
        self.num_actions = cfg.predictor.num_actions
        self.hidden_size = cfg.predictor.hidden_size
        self.num_gaussians = cfg.predictor.num_gaussians
        self.predicting_reward = cfg.predictor.predicting_reward
        self.predicting_termination = cfg.predictor.predicting_termination
