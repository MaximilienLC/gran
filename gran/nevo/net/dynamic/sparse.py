...
class Net:
    ...
    def __init__(self, dimensions):
        ...
        self.d_input, self.d_output = dimensions
        ...
        self.architectural_operations = [self.grow_node, self.prune_node]
    ...
    def grow_node(self, type="hidden"):
        ...
        if type == "input":
            ...
            if potential_in_nodes == []:
                potential_in_nodes = list(
                    dict.fromkeys(self.nodes["receiving"])
                )
