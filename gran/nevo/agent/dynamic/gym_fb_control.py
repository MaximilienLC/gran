...
from gran.nevo.agent.dynamic.base import BaseDynamicBot
from gran.nevo.net.dynamic.original import Net
from gran.util.gym_fb_control import get_task_info
...
class Agent(BaseDynamicBot):
    ...
    def initialize__(self) -> None:
        ...
        info = get_task_info(cfg.ecosystem.task)
        d_input, d_output, self.discrete_output, self.output_bound = info

        if cfg.ecosystem.pop_merge:
