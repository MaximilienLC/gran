...
from gran.bprop.gym_wrapper import Wrapper

from gran.util.wm_gym_fb_control import (
    score_tasks,
    get_env_state,
    get_task_name,
    reset_env_state,
...
class Space(BaseReinforcementSpace):
    ...
    def __init__(self, io_path="IO.wm"):
        """
        Args:
        ...
        self.env = Wrapper(gymnasium.make(get_task_name(cfg.ecosystem.task)))
