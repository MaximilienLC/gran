...
from gran.rands.bots.base import BotBase
...
class NetworkBotBase(BotBase):
    ...
    def initialize_nets(self) -> None:
        ...
        if not hasattr(self, "nets"):
            raise NotImplementedError(
                "Network Bots require the attribute 'nets': a list of nets."
            )
    ...
    def initialize_run_variables(self) -> None:
        ...
        """
        if (
            "transfer" in self.args.extra_arguments
            and "env" in self.args.extra_arguments["transfer"]
        ):
            self.seed = None
        ...
        if (
            "transfer" in self.args.extra_arguments
            and "fit" in self.args.extra_arguments["transfer"]
        ):
    ...
    def _setup_to_run(self) -> None:
        """
        Extra pre-run setup, can be implemented.
        """
        pass
    ...
    def _setup_to_save(self) -> None:
        """
        Extra pre-save setup, can be implemented.
        """
        pass
    ...
    def _reset(self) -> None:
        """
        Extra reset functionnality, can be implemented.
        """
        pass
