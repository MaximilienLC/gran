...
.. note::
    ...
    Gran's reproducibility across platforms, utilizing container technologies Docker
    ...
    Do note that we provide pre-built Docker & Apptainer images, meaning
    that you do not need to go through the setup steps presented in the next
